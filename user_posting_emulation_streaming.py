...
def run_infinite_post_data_loop():
    while True:
        ...
        with engine.connect() as connection:
            ...
            pin_invoke_url = "https://klbcewezi3.execute-api.us-east-1.amazonaws.com/prod/streams/streaming-1209b9ad90a5-pin/records"
            header = {'Content-Type': 'application/json'}
            response = requests.request("PUT", pin_invoke_url, headers=header, data=pin_payload)
            print(response.status_code)
            geo_invoke_url = "https://klbcewezi3.execute-api.us-east-1.amazonaws.com/prod/streams/streaming-1209b9ad90a5-geo/records"
            response = requests.request("PUT", geo_invoke_url, headers=header, data=geo_payload)
            print(response.status_code)
            user_invoke_url = "https://klbcewezi3.execute-api.us-east-1.amazonaws.com/prod/streams/streaming-1209b9ad90a5-user/records"
            response = requests.request("PUT", user_invoke_url, headers=header, data=user_payload)
            print(response.status_code)
